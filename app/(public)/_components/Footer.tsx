...
export default function Footer() {
  return (
    <footer style={{ background: '#150404', color: '#fff' }}>
      ...
      {/* ── Main columns ── */}
      <div className="w-full px-5 sm:px-6 2xl:px-20 pt-16 pb-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
      ...
      {/* ── Bottom bar ── */}
      <div className="w-full px-5 sm:px-6 2xl:px-20 py-5 flex flex-col sm:flex-row items-center justify-between gap-3"
