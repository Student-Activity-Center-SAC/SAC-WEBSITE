      ...
      <section style={{ background: '#faf6f1' }}>
        <div className="w-full px-6 sm:px-12 xl:px-20 py-20">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-0"
            ...
            {[
              { value: '5',   label: 'Learning Domains',  borderCls: 'hairline border-r border-b lg:border-b-0' },
              { value: '24', label: 'Active Clubs',      borderCls: 'hairline border-b lg:border-b-0 lg:border-r' },
              { value: statActivities > 0 ? `${statActivities}+` : '437+', label: 'Annual Activities', borderCls: 'hairline border-r' },
              { value: statStudents   > 0 ? `${statStudents}+`   : '5868+', label: 'Students Annually', borderCls: '' },
            ].map((s) => (
              <StatCounter
                key={s.label}
                value={s.value}
